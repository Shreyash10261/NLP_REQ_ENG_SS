...
if __name__ == "__main__":
    ...
    # Input paths
    input_train = os.path.join(project_dir, "requirements_ner_dataset", "output", "requirements_ner_train.json")
    input_dev = os.path.join(project_dir, "requirements_ner_dataset", "output", "requirements_ner_dev.json")
    input_test = os.path.join(project_dir, "requirements_ner_dataset", "output", "requirements_ner_test.json")
